...
const TraceKey = "skyscraper:trace"
...
type Trace interface {
	// SetTraceIDService set TraceID generator, default skyscraperIDGenerator
	// SetTraceIDService(IDService)
	// SetTraceIDService set SpanID generator, default skyscraperIDGenerator
